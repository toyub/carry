...
set :linked_files, fetch(:linked_files, []).push('config/sms_client.yml', 'config/database.yml', 'config/redis.yml', 'config/initializers/secret_token.rb', '.ruby-version', 'config/alipay.yml')
