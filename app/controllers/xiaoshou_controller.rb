class XiaoshouController < ApplicationController
  ...
  def to_builder
    Jbuilder.encode do |json|
      ...
      json.services current_store.store_services.order("id asc"), :id, :name, :code, :bargain_price, :bargain_price_enabled, :point, :retail_price, :standard_time, :engineer_level, :category
