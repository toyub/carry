class XiaoshouController < ApplicationController
  ...
  def to_builder
    Jbuilder.encode do |json|
      ...
      json.commissions current_store.commission_templates.available.for_saleman, :id, :name
      json.machanic_commissions current_store.commission_templates.available.for_machanic, :id, :name
