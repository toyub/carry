class XiaoshouController < ApplicationController
  ...
  def to_builder
    Jbuilder.encode do |json|
      ...
      json.services current_store.store_services.order("id asc"), :id, :name, :code, :bargain_price, :bargain_price_enabled, :point, :retail_price, :standard_time, :engineer_level, :category, :saleman_commission_template_id, :vip_price_enabled
      ...
      json.customers current_store.store_customer_entities do |entity|
        ...
        json.store_customer entity.store_customer, :phone_number, :full_name, :operator,
                                                   ...
                                                   :customer_asset, :integrity, :activeness
      end
      json.customer_categories current_store.store_customer_categories, :id, :name
