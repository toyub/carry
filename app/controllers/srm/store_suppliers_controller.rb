class Srm::StoreSuppliersController < Srm::BaseController
  def index
  ...
  def create
    ...
    if request.xhr?
      ...
      respond_to do |format|
        format.html {redirect_to srm_store_supplier_path(store_supplier)}
      end
    end
  end
  ...
  def update
    ...
    redirect_to srm_store_supplier_path(store_supplier)
  end
