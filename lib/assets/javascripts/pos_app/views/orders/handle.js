Mis.Views.PosOrderIndexView = Backbone.View.extend({
  ...
  afterVehicleFetch: function(){
    $('.vehicle_info .js-phone-number').val(Mis.current_vehicle.attributes.store_customer.phone_number);
    $('.vehicle_info [name="customer_name"]').val(Mis.current_vehicle.attributes.store_customer.full_name);
