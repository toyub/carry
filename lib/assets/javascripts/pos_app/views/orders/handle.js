Mis.Views.PosOrderIndexView = Backbone.View.extend({
  ...
  initVueModels: function(){
    ...
    Mis.Vues.MaterialItem.$on('remove:item', function(orderable_id){
      $('#js-orderables-materials input[data-itemid='+ orderable_id +']').removeAttr('checked');
    });

    Mis.Vues.PackageItem.$on('remove:item', function(orderable_id){
      $('#js-orderables-packages input[data-itemid='+ orderable_id +']').removeAttr('checked');
    });

    Mis.Vues.ServiceItem.$on('remove:item', function(orderable_id){
