Mis.Views.PosOrderIndexView = Backbone.View.extend({
  ...
  initVueModels: function(){
    ...
    Mis.Vues.MaterialItem.$on('remove:item', function(orderable_id, vue_remove_fun){
      $('#js-orderables-materials input[data-itemid='+ orderable_id +']').removeAttr('checked');
      if(_this.order){
        var item = _this.order.materials.items.find(function(item){return item.orderable_id == orderable_id});
        if(item){
          if(confirm('确定取消订单商品:【'+ item.name +'】？')){
            ...
            $('#js-orderables-materials input[data-itemid='+ orderable_id +']').prop('checked', true);
          }
        }else{
          vue_remove_fun.call();
        }
    ...
    Mis.Vues.PackageItem.$on('remove:item', function(orderable_id, vue_remove_fun){
      $('#js-orderables-packages input[data-itemid='+ orderable_id +']').removeAttr('checked');
      if(_this.order){
        var item = _this.order.packages.items.find(function(item){return item.orderable_id == orderable_id});
        if(item){
          if(confirm('确定取消订单商品:【'+ item.name +'】？')){
            ...
            $('#js-orderables-packages input[data-itemid='+ orderable_id +']').prop('checked', true);
          }
        }else{
          vue_remove_fun.call();
        }
    ...
    Mis.Vues.ServiceItem.$on('remove:item', function(orderable_id, vue_remove_fun){
      $('#js-orderables-services input[data-itemid='+ orderable_id +']').removeAttr('checked');
      if(_this.order){
        var item = _this.order.services.items.find(function(item){return item.orderable_id == orderable_id});
        if(item){
          if(confirm('确定取消订单商品:【'+ item.name +'】？')){
            ...
            $('#js-orderables-services input[data-itemid='+ orderable_id +']').prop('checked', true);
          }
        }else{
          vue_remove_fun.call();
        }
