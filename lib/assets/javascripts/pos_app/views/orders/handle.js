Mis.Views.PosOrderIndexView = Backbone.View.extend({
  ...
  initVueModels: function(){
    ...
    Mis.Vues.ServiceItem.$on('remove:item', function(orderable, vue_remove_fun){
      ...
      switch(orderable.orderable_type){
        case 'StoreMaterialService':
          $('input.js-material-service[data-itemid='+ orderable.orderable_id +']').removeAttr('checked');
          break;
        case 'StoreService':
          $('#js-orderables-services input[data-itemid='+ orderable.orderable_id +']').removeAttr('checked');
          break;
        case 'StorePackageService':
          $('input.js-package-service[data-itemid='+ orderable.orderable_id +']').removeAttr('checked');
          break;
        default:
          console.log(orderable.orderable_type)
      }
  ...
  setVehicleInfoData: function(e){
    ...
    this.storeVehicle.fetch({
      success: function(){
        ...
        $('.js-store-vehicle-license-number-input').prop("disabled", true);
        $('.js-add-vehicle').hide();
      }
    });
  },
