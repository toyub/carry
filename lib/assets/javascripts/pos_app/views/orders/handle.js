...
Mis.Views.PosOrderIndexView = Backbone.View.extend({
  ...
  initialize: function(){
    ...
    this.initVueModels();
    this.listenTo(this.storeVehicle, 'sync', this.afterFetchVehicle);
  },
  ...
  showAddVehicleForm: function(e){
    ...
    this.checkPhoneNumber(phone_number, function(response){
        new Mis.Views.NewCustomerView({customer: response.customer, license_number: license_number}, _this);
    })
  },
