   ...
   var OrderablesView = Backbone.View.extend({
    ...
    toggleServiceItem: function(evt){
      ...
      if(target.checked){
        ...
        var price = service.getPrice(Mis.Vues.VechileInfo.vehicleInfoData.store_customer);
        var _attrs = {
          name: service.get('name'),
          orderable_id: service.get('id'),
          orderable_type: 'StoreService',
          retail_price: service.get('retail_price'),
          vip_price: service.get('bargain_price'),
          quantity: 1,
          price: price,
          cached_price: price,
          discount: null,
    ...
    toggleMaterialItem: function(evt){
      ...
      if(target.checked){
        ...
        var price = material.getPrice(Mis.Vues.VechileInfo.vehicleInfoData.store_customer);
        var _attrs = {
    ...
    togglePackageServiceItem: function(evt){
      ...
      if(target.checked){
          ...
          assetable_type: 'StorePackageItem',
          assetable_id: package_service.id,
