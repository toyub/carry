   ...
   var OrderablesView = Backbone.View.extend({
    ...
    toggleServiceItem: function(evt){
      ...
      if(target.checked){
        ...
        var _attrs = service.toItemAttrs(Mis.current_vehicle.attributes.store_customer);
    ...
    toggleMaterialItem: function(evt){
      ...
      if(target.checked){
        ...
        var _attrs = material.toItemAttrs(Mis.current_vehicle.attributes.store_customer)
    ...
    showAssets: function(){
      var customer_id = Mis.current_vehicle.attributes.store_customer_id;
