   ...
   var OrderablesView = Backbone.View.extend({
    ...
    toggleServiceItem: function(evt){
      ...
      if(target.checked){
        ...
        Mis.Vues.ServiceItem.removeItem({target: { dataset: {orderableid: id, orderabletype: 'StoreService'}}});
      }
    },
    ...
    toggleMaterialItem: function(evt){
      ...
      if(target.checked){
        ...
        Mis.Vues.MaterialItem.removeItem({target: { dataset: {orderableid: id, orderabletype: 'StoreMaterialSaleinfo'}}});
      }
    },
    ...
    toggleMaterialServiceItem: function(evt){
      ...
      if(target.checked){
          ...
          orderable_id: id,
          orderable_type: 'StoreMaterialService',
          retail_price: 0,
          vip_price: 0,
          quantity: 1,
          price: 0,
        ...
        Mis.Vues.ServiceItem.removeItem({target: {dataset: {orderableid: id, orderabletype: 'StoreMaterialService'}}});
      }
    ...
    togglePackageItem: function(evt){
      ...
      if(target.checked){
        ...
        Mis.Vues.PackageItem.removeItem({target: { dataset: {orderableid: id, orderabletype: 'StorePackage'}}});
      }
    },
    ...
    togglePackageServiceItem: function(evt){
      ...
      if(target.checked){
          ...
          orderable_id: id,
          orderable_type: 'StorePackageService',
        ...
        Mis.Vues.ServiceItem.removeItem({target: {dataset: {orderableid: id, orderabletype: 'StorePackageService'}}});
      }
    },
