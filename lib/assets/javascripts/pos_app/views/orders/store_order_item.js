Mis.Views.StoreOrderItemView = Backbone.View.extend({
  ...
  events: {
    ...
    "click .js-package-item-li": "showItem",
    "click .js-material-item-li": "showItem"
  },
  initialize: function(){
    this.materialCollection = new Mis.Collections.StoreMaterialSaleinfos;
    this.packageCollection = new Mis.Collections.StoreMaterialSaleinfos;
  ...
  render: function(){
    ...
    this.$el.html(this.template({materials:  materials, packages: packages}));
