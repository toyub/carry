(function(win, Mis){
  ...
  var initSeriseSelect = function(){
    var vehicleBrandId = $(".js-select-vehicle-brand").val();
    if(vehicleBrandId == ""){
      vehicleBrandId = 0
    }
    var url = "/api/vehicle_brands/" + vehicleBrandId + "/search_series";
    $(".js-select-vehicle-series").select2({
      language: "zh-CN",
      ajax: {
        url: url,
        dataType: "json",
