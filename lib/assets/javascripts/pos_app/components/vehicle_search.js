(function(win, doc, $, $$MIS){
  ...
  function showAddVehicleForm(){
    new Mis.Views.NewCustomerView({customer: vehicleAndCustomerHandler.current_customer, license_number: getLicenseNumber(), phone_number: getPhoneNumber()}, newCustomerFormhandle);
  }
