class Mis.Models.StoreServiceRemind extends Backbone.Model
  ...
  urlRoot: ->
    Mis.Constants.StoreServiceCollection.get(@get 'store_service_id').url() + '/store_service_reminds'
  ...
  serviceName: ->
    Mis.Constants.StoreServiceCollection.get(@get 'store_service_id').get 'name'
