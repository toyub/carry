(function(win, doc, Backbone, $$MIS){
  ...
  var member_tmpl = JST["xianchang/groups/member"];
      ...
      if(members){
        members.forEach(function(member){
          var staff_info = {
            ...
            level_type_name: member.level_type_name,
            job_type_name: member.job_type_name,
            department_name: member.department_name,
            position_name: member.position_name
          };
          var staff_html = member_tmpl(staff_info);
